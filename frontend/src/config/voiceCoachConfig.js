...
export const voiceModes = {
  therapist: {
    name: 'Therapist',
    description: 'Professional and methodical guidance with focus on proper technique',
    rate: 0.9,
    pitch: 0.9,
    volume: 1.0,
    voicePreferences: [
...
export const confidenceLevels = {
  INSUFFICIENT: { threshold: 0, message: 'Low confidence - waiting for clearer pose' },
  MARGINAL: { threshold: 0.7, message: 'Moderate confidence - feedback quality may vary' },
  GOOD: { threshold: 0.85, message: 'Good confidence - reliable feedback' },
  EXCELLENT: { threshold: 0.95, message: 'Excellent confidence - very reliable feedback' },
};

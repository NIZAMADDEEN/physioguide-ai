        ...
        <div className="bg-primary rounded-3xl p-xl text-center text-on-primary relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-md">
            ...
            <p className="text-body-lg opacity-90 max-w-2xl mx-auto">
              Join thousands of patients using AI to heal faster and smarter. No
              commitment required.
            </p>
            <div className="flex flex-col sm:flex-row gap-md justify-center pt-md">
              <button className="bg-white text-primary px-xl py-md rounded-xl font-bold hover:bg-surface-container-low transition-all">
                Get Started Free
              </button>
              <button className="bg-transparent border-2 border-on-primary text-on-primary px-xl py-md rounded-xl font-bold hover:bg-white/10 transition-all">
                Contact Sales
              </button>
            </div>
          </div>

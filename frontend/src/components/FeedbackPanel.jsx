    ...
    <div className="d-flex flex-column gap-3 h-100">
      ...
      >
        <div className="d-flex justify-content-between align-items-start mb-2">
          <div>
            <span className="badge bg-primary-container text-on-primary text-label-sm rounded-pill mb-1">
              {exercise.category || "Therapy"}
            </span>
            <h2
              className="text-headline-md font-bold mb-0 text-on-surface"
              style={{ fontSize: "18px" }}
            >
              {exercise.name}
            </h2>
        ...
        <p
          className="text-body-md text-on-surface-variant mb-0"
      ...
      <div className="row g-3">
        ...
        <div className="col-6">
          <Card
            padding="md"
            className="border-0 shadow-sm text-center h-100 d-flex flex-column justify-content-center"
        ...
        <div className="col-6">
          ...
          >
            ...
            <div
              className="text-label-sm text-outline mt-2"
              style={{ fontSize: "10px" }}
            >
              {isPaused
                ? "Timer Paused"
        ...
        <div className="col-12">
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-2">
              <div
                className="text-label-sm text-on-surface-variant text-uppercase"
                style={{ fontSize: "10px", letterSpacing: "0.5px" }}
              >
                Form Accuracy
              </div>
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div className="flex-grow-1">
                ...
                <div
                  className="d-flex justify-content-between text-outline"
                  style={{ fontSize: "9px" }}
                >
                  <span>0%</span>
      ...
      <Card
        padding="md"
        className="flex-grow-1 border-0 shadow-sm d-flex flex-column"
        ...
        >
          {!cameraActive ? (
            <div className="text-center text-outline-variant py-4">
              ...
              <p className="text-body-md mb-0" style={{ fontSize: "12px" }}>
                Camera offline.
              </p>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-center flex-column text-center py-4 text-secondary-color">
              <span
                className="material-symbols-outlined mb-2"
                style={{ fontSize: "28px", color: "#00e676" }}
              >
                task_alt
              </span>
              <p
                className="text-body-md mb-0 font-bold"
                style={{ fontSize: "12px", color: "#00e676" }}
              >
                Form is aligned!
              </p>
              <span className="text-outline" style={{ fontSize: "10px" }}>
              ...
              {corrections.map((corr) => (
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    ...
                    <div
                      className="text-outline text-end"
                      style={{ fontSize: "8px" }}
                    >
                      {corr.timestamp}
                    </div>
        ...
        >
          {!cameraActive ? (
            ...
            <div className="text-center text-outline py-4">
              <p
                className="text-body-md mb-0 animate-pulse"
                style={{ fontSize: "12px" }}
              >
                Calibrating & preparing rep count...
              </p>
            </div>
          ) : (
            <div className="d-flex flex-column gap-2">

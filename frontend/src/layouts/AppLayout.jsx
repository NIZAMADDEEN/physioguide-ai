...
export default function AppLayout() {
  ...
  const currentRoute = SIDEBAR_NAV.find((nav) =>
  ...
  return (
    <div className="d-flex vh-100 bg-background overflow-hidden">
      ...
      <div className="flex-grow-1 d-flex flex-column overflow-hidden position-relative">
        {/* Top Bar */}
        <header
          className="bg-surface-lowest border-bottom border-outline-variant d-flex align-items-center justify-content-between px-4"
        ...
        >
          ...
          <div className="d-flex align-items-center gap-4">
            <button
              className="btn p-1 text-on-surface-variant position-relative"
            ...
            <div className="d-flex align-items-center gap-2">
              <div className="d-none d-md-flex flex-column align-items-end me-2">
                ...
                <span className="text-label-sm text-on-surface-variant fw-normal text-capitalize">
                  {user?.role}
                </span>
              </div>
              <div
        ...
        <main className="flex-grow-1 overflow-y-auto p-3 p-md-4 p-lg-5">
          <div
            className="container-fluid max-w-container mx-auto p-0"
